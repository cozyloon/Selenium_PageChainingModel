...
public class LoginSingleton {
    ...
    public LoginSingleton(WebDriver driver) {
        this.driver = driver;
    }

    public static LoginSingleton getInstance(WebDriver driver) {
        return new LoginSingleton(driver);
    }

    public HomeSingleton loginToApp(String username, String password) {
        ...
        element3.click();
        return new HomeSingleton(driver);
    }
